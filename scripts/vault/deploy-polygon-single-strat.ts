...
const want = web3.utils.toChecksumAddress("0x82ee4008E2DE03F3A3E25434506f0d4d423afaaD"); // LP addr
const LMP = web3.utils.toChecksumAddress("0x873801Ae2ff12d816Db9a7B082F5796BEC64C82C");

const vaultParams = {
  mooName: "Moo QuickSwap LMP-ETH",
  mooSymbol: "mooQuickSwapLMP-ETH",
  delay: 21600,
};

const strategyParams = {
  want,
  rewardPool: "0x0997BA719cdF1F216d8A14b52AD3355Bd2F9f477",
  ...
  outputToLp1Route: [QUICK, ETH, LMP],
